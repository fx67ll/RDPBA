export default {
  ...
  'pages.welcome.advancedComponent': 'Home Page',
  'pages.welcome.link': 'Visit',
  'pages.welcome.advancedLayout': 'Tech & Life Blog',
  'pages.welcome.Message': "Welcome to `react.fx67ll.com` – this is fx67ll's Recat.js  demo site~",
  'pages.welcome.alertMessage': 'For more wonderful demo sites, please visit `https://fx67ll.com`',
